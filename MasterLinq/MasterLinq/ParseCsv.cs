...
namespace MasterLinq
{
    public class ParseCsvDemo
    {
        ...
        public static void MinMaxSumAverage(string file)
        {
            ...
            Console.WriteLine($"The sum of numbers in data list = {data.Sum()}");
        }
        ...
        public static void SequenceEqual(string file)
        {
            ...
            bool areEqual = list.SequenceEqual(list2, new PlayersComparer());
        ...
        public static void SkipWhile()
        {
            ...
            foreach (var i in intList.SkipWhile(x=>x<=3))
            {
                Console.WriteLine(i);
            }
        }
        ...
        public static void DefaultIfEmptyDemo(string file)
        {
            ...
            try
            {
                string nissan = cars.First(n => n.Equals("Porshe"));
            ...
            string nissan2 = cars.Where(n => n.Equals("Porshe")).DefaultIfEmpty("default").First();
            Console.WriteLine(nissan2);

            string[] names = new[] {"Bob", "Mary"};

            string result1 = names.FirstOrDefault(name => name.Length > 5);
            string result2 = names.DefaultIfEmpty("default").First(name => name.Length > 5);
